...
class ScrambleCompletionPage extends StatelessWidget {
  ...
  void _submitFeeling(BuildContext context, String feelingLabel) async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(content: Text('Scrambled egg - 100% done, user feeling $feelingLabel!')),
    );
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              SizedBox(height: 60),
              Image.asset(
                'assets/images/competed-scrambled-egg.png',
                height: 180,
              ),
              SizedBox(height: 30),
              Text(
